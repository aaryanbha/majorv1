...
import 'provider/single_test_results_pass_four_provider.dart';

class SingleTestResultsPassFourScreen extends StatefulWidget {
  const SingleTestResultsPassFourScreen({Key? key}) : super(key: key);

  @override
  SingleTestResultsPassFourScreenState createState() =>
      SingleTestResultsPassFourScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SingleTestResultsPassFourProvider(),
        child: SingleTestResultsPassFourScreen());
  }
}

class SingleTestResultsPassFourScreenState
    extends State<SingleTestResultsPassFourScreen> {
  @override
  void initState() {
    super.initState();
  }
