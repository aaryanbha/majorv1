...
import 'provider/single_test_results_fail_four_provider.dart';

class SingleTestResultsFailFourScreen extends StatefulWidget {
  ...
  @override
  SingleTestResultsFailFourScreenState createState() =>
      SingleTestResultsFailFourScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => SingleTestResultsFailFourProvider(),
      child: SingleTestResultsFailFourScreen(),
    );
  }
}

class SingleTestResultsFailFourScreenState
    extends State<SingleTestResultsFailFourScreen> {
  @override
  void initState() {
    super.initState();
  }
