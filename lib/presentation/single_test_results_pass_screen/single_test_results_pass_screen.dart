...
import 'provider/single_test_results_pass_provider.dart';

class SingleTestResultsPassScreen extends StatefulWidget {
  const SingleTestResultsPassScreen({Key? key}) : super(key: key);

  @override
  SingleTestResultsPassScreenState createState() =>
      SingleTestResultsPassScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SingleTestResultsPassProvider(),
        child: SingleTestResultsPassScreen());
  }
}

class SingleTestResultsPassScreenState
    extends State<SingleTestResultsPassScreen> {
  @override
  void initState() {
    super.initState();
  }
