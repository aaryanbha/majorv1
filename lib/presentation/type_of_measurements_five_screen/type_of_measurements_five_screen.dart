...
import 'provider/type_of_measurements_five_provider.dart';

class TypeOfMeasurementsFiveScreen extends StatefulWidget {
  const TypeOfMeasurementsFiveScreen({Key? key}) : super(key: key);

  @override
  TypeOfMeasurementsFiveScreenState createState() =>
      TypeOfMeasurementsFiveScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => TypeOfMeasurementsFiveProvider(),
        child: TypeOfMeasurementsFiveScreen());
  }
}

class TypeOfMeasurementsFiveScreenState
    extends State<TypeOfMeasurementsFiveScreen> {
  @override
  void initState() {
    super.initState();
  }
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(
                    ...
                    children: [
                      Text("msg_electrical_conductivity".tr,
