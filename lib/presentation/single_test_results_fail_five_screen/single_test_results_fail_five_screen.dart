...
import 'provider/single_test_results_fail_five_provider.dart';

class SingleTestResultsFailFiveScreen extends StatefulWidget {
  const SingleTestResultsFailFiveScreen({Key? key}) : super(key: key);

  @override
  SingleTestResultsFailFiveScreenState createState() =>
      SingleTestResultsFailFiveScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SingleTestResultsFailFiveProvider(),
        child: SingleTestResultsFailFiveScreen());
  }
}

class SingleTestResultsFailFiveScreenState
    extends State<SingleTestResultsFailFiveScreen> {
  @override
  void initState() {
    super.initState();
  }
