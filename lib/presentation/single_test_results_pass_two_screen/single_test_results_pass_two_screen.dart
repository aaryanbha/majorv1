...
import 'provider/single_test_results_pass_two_provider.dart';

class SingleTestResultsPassTwoScreen extends StatefulWidget {
  const SingleTestResultsPassTwoScreen({Key? key}) : super(key: key);

  @override
  SingleTestResultsPassTwoScreenState createState() =>
      SingleTestResultsPassTwoScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SingleTestResultsPassTwoProvider(),
        child: SingleTestResultsPassTwoScreen());
  }
}

class SingleTestResultsPassTwoScreenState
    extends State<SingleTestResultsPassTwoScreen> {
  @override
  void initState() {
    super.initState();
  }
