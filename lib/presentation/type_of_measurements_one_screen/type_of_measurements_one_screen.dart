...
import 'provider/type_of_measurements_one_provider.dart';

class TypeOfMeasurementsOneScreen extends StatefulWidget {
  const TypeOfMeasurementsOneScreen({Key? key}) : super(key: key);

  @override
  TypeOfMeasurementsOneScreenState createState() =>
      TypeOfMeasurementsOneScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => TypeOfMeasurementsOneProvider(),
        child: TypeOfMeasurementsOneScreen());
  }
}

class TypeOfMeasurementsOneScreenState
    extends State<TypeOfMeasurementsOneScreen> {
  @override
  void initState() {
    super.initState();
  }
