...
import 'provider/single_test_results_fail_one_provider.dart';

class SingleTestResultsFailOneScreen extends StatefulWidget {
  const SingleTestResultsFailOneScreen({Key? key}) : super(key: key);

  @override
  SingleTestResultsFailOneScreenState createState() =>
      SingleTestResultsFailOneScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SingleTestResultsFailOneProvider(),
        child: SingleTestResultsFailOneScreen());
  }
}

class SingleTestResultsFailOneScreenState
    extends State<SingleTestResultsFailOneScreen> {
  @override
  void initState() {
    super.initState();
  }
