...
import 'provider/single_test_results_fail_two_provider.dart';

class SingleTestResultsFailTwoScreen extends StatefulWidget {
  const SingleTestResultsFailTwoScreen({Key? key})
      : super(
          key: key,
        );

  @override
  SingleTestResultsFailTwoScreenState createState() =>
      SingleTestResultsFailTwoScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => SingleTestResultsFailTwoProvider(),
      child: SingleTestResultsFailTwoScreen(),
    );
  }
}

class SingleTestResultsFailTwoScreenState
    extends State<SingleTestResultsFailTwoScreen> {
  @override
  void initState() {
    super.initState();
  }
