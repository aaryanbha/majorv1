...
import 'provider/type_of_measurements_eight_provider.dart';

class TypeOfMeasurementsEightScreen extends StatefulWidget {
  const TypeOfMeasurementsEightScreen({Key? key}) : super(key: key);

  @override
  TypeOfMeasurementsEightScreenState createState() =>
      TypeOfMeasurementsEightScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => TypeOfMeasurementsEightProvider(),
        child: TypeOfMeasurementsEightScreen());
  }
}

class TypeOfMeasurementsEightScreenState
    extends State<TypeOfMeasurementsEightScreen> {
  @override
  void initState() {
    super.initState();
  }
