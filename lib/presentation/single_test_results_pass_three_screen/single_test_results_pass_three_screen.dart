...
import 'provider/single_test_results_pass_three_provider.dart';

class SingleTestResultsPassThreeScreen extends StatefulWidget {
  const SingleTestResultsPassThreeScreen({Key? key}) : super(key: key);

  @override
  SingleTestResultsPassThreeScreenState createState() =>
      SingleTestResultsPassThreeScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => SingleTestResultsPassThreeProvider(),
        child: SingleTestResultsPassThreeScreen());
  }
}

class SingleTestResultsPassThreeScreenState
    extends State<SingleTestResultsPassThreeScreen> {
  @override
  void initState() {
    super.initState();
  }
